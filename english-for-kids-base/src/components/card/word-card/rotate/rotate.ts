...
export class Rotate extends BaseComponent {
  constructor() {
    super('div', ['word-card__rotate']);
    this.element.innerHTML = `<svg class="word-card__rotate-img" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    width="94.073px" height="94.072px" viewBox="0 0 94.073 94.072" style="enable-background:new 0 0 94.073 94.072;"
    xml:space="preserve">
 <g>
   <g>
     <path class="path" d="M91.465,5.491c-0.748-0.311-1.609-0.139-2.18,0.434l-8.316,8.316C72.046,5.057,60.125,0,47.399,0
     ...
     <path class="path" d="M90.192,56.328H77.455c-0.839,0-1.59,0.523-1.878,1.312c-3.729,10.193-12.992,17.972-23.598,19.814
